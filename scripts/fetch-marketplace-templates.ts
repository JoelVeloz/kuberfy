...
const MANUAL_TEMPLATES: Template[] = [
  ...
  },
  {
    id: "rustfs",
    name: "RustFS",
    description: "S3-compatible object storage with a built-in web console, on port 9001.",
    source: "official",
    sourceUrl: "https://github.com/rustfs/rustfs",
    logo: "https://avatars.githubusercontent.com/u/151849438?v=4",
    image: "rustfs/rustfs:latest",
    port: 9000,
    envVars: [
      { key: "RUSTFS_ACCESS_KEY", default: null, secret: true },
      { key: "RUSTFS_SECRET_KEY", default: null, secret: true },
    ],
    tags: ["storage", "s3", "object-storage"],
    volumes: ["/data"],
    category: "application",
  ...
  },
  {
    id: "s3manager",
    name: "S3 Manager",
    description: "Web UI for any S3-compatible storage. Paste the endpoint and credentials of the storage it should manage.",
    source: "official",
    sourceUrl: "https://github.com/cloudlena/s3manager",
    logo: "https://avatars.githubusercontent.com/u/6780471?v=4",
    image: "cloudlena/s3manager:latest",
    port: 8080,
    envVars: [
      { key: "ENDPOINT", default: null, secret: false },
      { key: "USE_SSL", default: "true", secret: false },
      { key: "ACCESS_KEY_ID", default: null, secret: false },
      { key: "SECRET_ACCESS_KEY", default: null, secret: false },
    ],
    tags: ["storage", "s3", "ui"],
    volumes: [],
    category: "application",
